...
func (mc *MessageCreate) SetAuthorName(s string) *MessageCreate {
	mc.mutation.SetAuthorName(s)
	return mc
}
...
func (mc *MessageCreate) check() error {
	...
	if _, ok := mc.mutation.AuthorName(); !ok {
		return &ValidationError{Name: "author_name", err: errors.New(`ent: missing required field "Message.author_name"`)}
	}
	if v, ok := mc.mutation.AuthorName(); ok {
...
func (mc *MessageCreate) createSpec() (*Message, *sqlgraph.CreateSpec) {
	...
	if value, ok := mc.mutation.AuthorName(); ok {
