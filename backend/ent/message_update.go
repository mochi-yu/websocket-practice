...
func (mu *MessageUpdate) SetAuthorName(s string) *MessageUpdate {
	mu.mutation.SetAuthorName(s)
	return mu
}

// SetNillableAuthorName sets the "author_name" field if the given value is not nil.
func (mu *MessageUpdate) SetNillableAuthorName(s *string) *MessageUpdate {
	if s != nil {
		mu.SetAuthorName(*s)
	}
	return mu
...
func (mu *MessageUpdate) check() error {
	...
	if v, ok := mu.mutation.AuthorName(); ok {
		if err := message.AuthorNameValidator(v); err != nil {
			return &ValidationError{Name: "author_name", err: fmt.Errorf(`ent: validator failed for field "Message.author_name": %w`, err)}
		}
	}
	return nil
}
...
func (mu *MessageUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.AuthorName(); ok {
		_spec.SetField(message.FieldAuthorName, field.TypeString, value)
	}
...
// SetAuthorName sets the "author_name" field.
func (muo *MessageUpdateOne) SetAuthorName(s string) *MessageUpdateOne {
	muo.mutation.SetAuthorName(s)
	return muo
}

// SetNillableAuthorName sets the "author_name" field if the given value is not nil.
func (muo *MessageUpdateOne) SetNillableAuthorName(s *string) *MessageUpdateOne {
	if s != nil {
		muo.SetAuthorName(*s)
	}
	return muo
...
func (muo *MessageUpdateOne) check() error {
	...
	if v, ok := muo.mutation.AuthorName(); ok {
		if err := message.AuthorNameValidator(v); err != nil {
			return &ValidationError{Name: "author_name", err: fmt.Errorf(`ent: validator failed for field "Message.author_name": %w`, err)}
		}
	}
...
func (muo *MessageUpdateOne) sqlSave(ctx context.Context) (_node *Message, err error) {
	...
	if value, ok := muo.mutation.AuthorName(); ok {
		_spec.SetField(message.FieldAuthorName, field.TypeString, value)
	}
